...
export const POWER_UNIT_TD: WoT.ExposedThingInit = {
  ...
  events: {
    ...
    physicalLinkChanged: {
      description:
        "Una o piu' parti fisiche si sono collegate o scollegate: il gemello ha cambiato sorgente dati.",
      data: {
        type: "object",
        properties: {
          changes: {
...
export const createPowerUnitThing = async (wot: typeof WoT, twin: TwinRegistry) => {
